...
function GaugeControl({ label, unit, value, min, max, step, color, marks, onChange }) {
  ...
  return (
    <div style={{ position: "relative", width: "100%", userSelect: "none" }}>
      <div style={{ position: "relative", height: "106px", width: "100%" }}>
        <svg viewBox="0 0 240 148" style={{ height: "100%", width: "100%", overflow: "visible" }}>
          {marks.map((mark) => {
            ...
            return (
              <text key={mark} x={pos.x} y={pos.y} textAnchor="middle"
                fill="#b0b0b8" fontSize="9" fontWeight="600">
                {mark === 0 ? "00" : `${mark}`}
              </text>
            );
          })}
      ...
      <p style={{
        margin: "1px 0 0 0", textAlign: "center", fontSize: "0.82rem",
...
function ValueBadge({ title, value }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "2px", minWidth: "64px" }}>
      <div style={{
        background: "#cc0000", color: "#fff", fontSize: "10px", fontWeight: "800",
        padding: "2px 8px", borderRadius: "3px", letterSpacing: "0.04em", whiteSpace: "nowrap",
      }}>
        {title}
      </div>
      <div style={{
        ...
        padding: "1px 10px", textAlign: "center", minWidth: "52px",
      }}>
        {value}
      </div>
    </div>
...
export default function AGTutor() {
  ...
  const model = useMemo(() => {
    const effectiveBreath = Math.max(tidalVolume - deadSpace, 0);
    ...
    const alveolarOxygen = paco2 === null ? null : Math.max(fio2 * (760 - 47) - paco2 / 0.8, 0);
    const pao2 = alveolarOxygen === null ? null : Math.max(alveolarOxygen - 5, 0);
    const aaGradient = alveolarOxygen === null ? null : 5;
    const ventilationState = !isVentilating
      ...
      : "Normal ventilation";
    const warning =
      frequency === 0 ? "Frequency is zero — ventilation stops."
      : effectiveBreath === 0 ? "Dead space \u2265 tidal volume \u2014 no alveolar ventilation."
      : null;
    return { alveolarVentilationL, paco2, alveolarOxygen, pao2, aaGradient, ventilationState, warning };
    ...
    <>
      ...
      <div className="ag-root">
        ...
        <div className="ag-left">
          ...
          {/* Row 1: Frequency + Dead Space */}
          <div className="gauge-grid">
            <GaugeControl label="Frequency" unit="breaths/min"
              value={frequency} min={0} max={40} step={1} color="#16a34a"
              marks={[0, 10, 20, 30, 40]} onChange={setFrequency} />
            <GaugeControl label="Dead Space" unit="ml"
              value={deadSpace} min={0} max={1000} step={10} color="#2563eb"
              marks={[0, 250, 500, 750, 1000]} onChange={setDeadSpace} />
          </div>

          <div style={{ borderTop: "1px solid #ebebeb", margin: "8px 0" }} />

          {/* Row 2: Tidal Volume + FiO₂ */}
          <div className="gauge-grid" style={{ alignItems: "center" }}>
            <GaugeControl label="Tidal Volume" unit="ml/breath"
              value={tidalVolume} min={0} max={3000} step={10} color="#ea580c"
              marks={[0, 750, 1500, 2250, 3000]} onChange={setTidalVolume} />
            ...
            <div style={{
              ...
              <div style={{
                ...
                border: "1.5px solid #d1d5db", borderRadius: "999px",
                ...
                <button type="button"
                  ...
                  style={{
                    ...
                    fontSize: "1.1rem", color: "#6b7280", cursor: "pointer",
                    display: "flex", alignItems: "center", justifyContent: "center",
                  }}>&#8722;</button>
                <div style={{
                  borderLeft: "1.5px solid #d1d5db", borderRight: "1.5px solid #d1d5db",
                  background: "#fff", padding: "2px 10px", fontSize: "0.9rem",
                  fontWeight: "600", color: "#374151", minWidth: "50px", textAlign: "center",
                }}>
                  {fio2.toFixed(2)}
                </div>
                <button type="button"
              ...
              <input type="range" min="0.21" max="1" step="0.01" value={fio2}
        ...
        <div className="ag-right">
          ...
          <div style={{ position: "relative", width: "100%", flex: 1, minHeight: 0 }}>
            <img
              ...
              style={{
                ...
                objectFit: "fill", objectPosition: "center top", display: "block",
              }}
            />
            ...
            <div style={{
              ...
              display: "flex", flexDirection: "column",
              alignItems: "center", gap: "4px", zIndex: 5,
            }}>
            ...
            <div style={{
              ...
              borderRadius: "4px", zIndex: 5, minWidth: "120px",
            }}>
              <div style={{
                textAlign: "center", fontWeight: "700", fontSize: "0.85rem",
                padding: "4px 12px", borderBottom: "1px solid #e5e7eb", color: "#111",
              }}>ABG</div>
              <div style={{
              ...
              <div style={{
                display: "flex", justifyContent: "space-between",
                padding: "4px 12px", fontSize: "0.8rem", color: "#374151",
              }}>
                <span>PaCO&#8322;</span>
          ...
          {/* Bottom: A-a gradient */}
          <div style={{ position: "absolute", bottom: 0, left: 0, width: "100%", padding: "10px 12px 12px 12px", zIndex: 5 }}>
            <p style={{ fontSize: "0.75rem", fontWeight: "700", color: "#1a202c", marginBottom: "5px" }}>
              Alveolar-arterial gradient
            </p>

            <div style={{
              display: "flex", border: "1px solid #c8d0dc", borderRadius: "3px",
              overflow: "hidden", background: "#fff", maxWidth: "200px",
            }}>
              <div style={{
                background: "#b8c8e0", color: "#334155", padding: "3px 7px",
                fontWeight: "700", fontSize: "0.7rem", display: "flex", alignItems: "center",
              }}>A</div>
              <div style={{
                flex: 1, textAlign: "center", padding: "3px 4px",
                fontWeight: "600", fontSize: "0.88rem", color: "#111",
                borderRight: "1px solid #e2e8f0",
              }}>
                {fmt(model.alveolarOxygen)}
              </div>
              <div style={{
                background: "#7a9ec0", color: "#fff", padding: "3px 7px",
                fontWeight: "700", fontSize: "0.7rem", display: "flex", alignItems: "center",
              }}>a</div>
              <div style={{
                flex: 1, textAlign: "center", padding: "3px 4px",
            ...
            <div style={{
              marginTop: "4px", background: "#fff", border: "1px solid #c8d0dc",
              borderRadius: "3px", padding: "3px 7px", fontSize: "0.88rem",
              fontWeight: "600", color: "#111", maxWidth: "200px",
            }}>
            ...
            {model.warning && (
              <div style={{
                marginTop: "4px", fontSize: "0.62rem", color: "#c53030",
                background: "rgba(255,255,255,0.7)", borderRadius: "3px",
                padding: "2px 6px", maxWidth: "200px",
              }}>
                {model.warning}
              </div>
            )}
